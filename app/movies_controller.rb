...
def can_be_created_with_a_hash_of_attributes
  ...
  #will pass in the hash
end


def can_be_created_in_a_block

  movie = Movie.create do |the_movie|
    the_movie.title = "Home Alone"
    the_movie.release_date = 1990
    end
...
def can_find_using_where_clause_and_be_sorted
  ...
  # i just played around with this until my test passed based on the rspec.
  #I'm not sure i entirely understand the syntax of whats going on after .order
end
...
def can_update_multiple_items_at_once
  ...
  5.times do |movie|
    Movie.create(title: "Movie_#{movie}", release_date: 2000+movie)
  end
...
def can_destroy_all_items_at_once
  10.times do |move|
    Movie.create(title: 'Movie_#{move}')
